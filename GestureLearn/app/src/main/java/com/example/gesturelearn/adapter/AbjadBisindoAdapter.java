...
public class AbjadBisindoAdapter extends RecyclerView.Adapter<AbjadBisindoAdapter.ViewHolder> {
    ...
    public AbjadBisindoAdapter(List<Sign> signList, OnItemClickListener listener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_abjad_bisindo, parent, false);
